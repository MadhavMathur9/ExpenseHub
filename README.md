<h1 align="center">ExpenseHub</h1>

<div align="center">

<h2 align="center">
  <a href="LICENSE">
    <img src="https://github.com/MadhavMathur/ExpenseHub/blob/main/Images/MIT%20License.png" alt="MIT License" />
  </a>
</h2>
...
The following roadmap outlines planned features and improvements for ExpenseHub, inspired by community feedback and trends in modern money management applications:
...
```bash
git clone https://github.com/MadhavMathur/ExpenseHub.git
```

## How to Run ExpenseHub on Your System 🛠🛠
...
- This project is licensed under the MIT License - see the [LICENSE](https://github.com/MadhavMathur/ExpenseHub?tab=MIT-1-ov-file) file for details.
- The project ExpenseHub is packaged and distributed using the [MIT License](https://choosealicense.com/licenses/mit/) which allows for commercial use, distribution, modification and private use provided that all copies of the software contain the same license and copyright.
